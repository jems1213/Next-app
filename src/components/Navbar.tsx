        ...
        <div className={styles.navInner} style={{padding: '0 12px', gap: 8}}>
          ...
          <div className={styles.navActions}>
            ...
            <Link href="/cart" prefetch={false} aria-label="View cart" className={styles.iconButton}>
              ...
              {mounted && user && typeof totalQuantity === 'number' && totalQuantity > 0 ? <span className={styles.cartBadge}>{totalQuantity}</span> : null}
            </Link>
                ...
                {menuOpen ? (
                  <div className={styles.accountMenu}>
                    ...
                    <div className={styles.accountMenuList}>
                      ...
                      <Link href="/profile" className={styles.accountMenuItem} onClick={() => setMenuOpen(false)}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5zm0 2c-4 0-7 2-7 4v1h14v-1c0-2-3-4-7-4z" /></svg>
                        <span>Profile</span>
                      </Link>
